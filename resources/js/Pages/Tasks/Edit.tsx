...
export default function Edit({ task, projects, users }: { task: { data: Task }, projects: { data: Project[] }, users: { data: User[] } }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        priority: dataObj.priority || 'medium',
        project_id: dataObj.project_id || '',
        assigned_to: dataObj.assigned_to?.id || '',
        due_date: dataObj.due_date || '',
    });

    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('tasks.update', dataObj.id));
    };
    ...
    return (
        ...
        >
            <Head title={`Edit Task: ${dataObj.name}`} />
