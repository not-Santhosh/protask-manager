...
export default function Edit({ project }: { project: { data: Project } }) {
    const dataObj = project.data;
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('projects.update', dataObj.id));
    };
    ...
    return (
        ...
        >
            <Head title={`Edit Project: ${dataObj.name}`} />
